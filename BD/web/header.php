<?php 
    ...
    // Verifica o valor da variável $header
    // Se o valor da variável $header for igual a 1 incluirá esse header abaixo
    if($header == 1){
        echo '
            ...
            <header>
                <div class="container-fluid row d-flex justify-content-around align-items-center">
                    ...
                    <div class="col-3 d-flex d-md-flex d-none align-self-center mb-4 ms-5 me-5">
                        <form class="d-flex form-pesquisar w-100" method="post" action="buscarEventos.php">
