    ...
    if (autenticar($db_con)) {
        if (isset($_GET['criador_evento']) && isset($_GET['id_evento'])) {
            ...
            if ($consultaUsuario->rowCount() > 0) {
                ...
                $consulta2 = $db_con->prepare("DELETE FROM Favorita WHERE fk_EVENTO_id_evento = '$id_evento'
                and fk_USUARIO_id_usuario = '$criador_id'");
                ...
                if ($consulta2->execute()) {
                    ...
                    $resposta["sucesso"] = 0;
                    $resposta["erro"] = "Erro no delete na tabela Favorita: " . $consulta2->errorInfo()[2];
                }
            } 
            else {
